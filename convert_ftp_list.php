...
$file=fopen("ftp_list.txt","r") or exit("Unable to open ftp_list.txt"); //abre o ficheiro para leitura
$contents = fread($file, filesize("ftp_list.txt")); //read all the file to $contents
fclose($file); //close 
$lines = explode("\n", $contents);
$lines = array_unique($lines); //apenas as entradas unicas. Dupes will be ignored.
$lines = str_replace("\n","",$lines); //
...
//$ripe_url="http://www.ratite.com/whois/whois.cgi?domain=$ip"; 		//global
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////   START GET STATUS DETAILS AND CONTENTS FOR ALL IPs   /////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$path = "/";
set_time_limit(60);
...
//var_dump( $ftp_file_list);
//$contents[$i] = strrchr($ftp_file_list[$i]," ");

//$crap = '[drwx-]{1,4}[drw-]{1,3}[drw-]{1,3}[ ]{3}[0-9] user[ ]{5}group[ ]{1,20}[0-9]{1,11} [a-zA-Z]{3} [0-9]{1,2} [0-9]{1,2}:[0-9]{1,2} ';
//$result['filelist'] = ereg_replace($crap,'',$result['filelist']);
...
$file=fopen("det_list.txt","a+") or exit("Unable to open ftp_list.txt"); //abre o ficheiro para escrita dos detalhes em append mode
for ($n = 0; $n < count($lines); $n++){
$string_line[$n] = $lines[$n]." ,, "."\$ssl"." ,, ".$country_td[$n]." ,, "."\$team"." ,, "."\$details"." ,, "."\$stro_type"." ,, ".$tdate[$n]." ,, ".$status[$n]."\r\n";
