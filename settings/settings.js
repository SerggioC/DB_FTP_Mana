...
for (var i = 0; i < list.length; ++i) {
	...
	newbuttons += "<td><input type='button' value='" + list[i].getAttribute('value') + " ' onClick=' " + list[i].getAttribute('onClick') + " '></td> ";
	j++;
...
document.standaard.release.focus();
return;
}

if (document.standaard.section.value == 0) {
alert("Please Select Release Section");
document.standaard.section.focus();
return;
}

if (document.standaard.quicklink.value == ""){
alert("Please Enter FTP address");
document.standaard.quicklink.focus();
return;
}

if (document.standaard.message.value == ""){
alert("Please Enter Some Message!");
document.standaard.message.focus();
return;
}

list = document.getElementById('boards_js_styled').getElementsByTagName('input');
for (var i = 0; i < list.length; ++i){
list[i].click();
}
