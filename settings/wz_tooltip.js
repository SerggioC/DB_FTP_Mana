...
config. BgColor 		= 'transparent' //'#E2E7FF' // Background colour (HTML colour value, in quotes)
...
config. OffsetX			= -14 //14		// Horizontal offset of left-top corner from mousepointer
config. OffsetY			= 0 //8 		// Vertical offset
